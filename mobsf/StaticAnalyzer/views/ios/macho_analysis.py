...
class Checksec:
    ...
    def is_symbols_stripped(self): # Aug 2023 merge; The MobSF version appears to strip more symbols, so I retained it instead of cyberspect, assuming that these additional symbols needed stripping
