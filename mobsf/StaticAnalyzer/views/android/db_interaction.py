...
def get_context_from_db_entry(db_entry: QuerySet) -> dict:
    ...
    try:
        ...
        context = {
            ...
            'network_security': python_list(db_entry[0].NETWORK_SECURITY), # Note that the mobsf upgrades in August 2023 made this object a python_dict. I am retaining the version present in the Cyberspect codebase
